...
def help(message):
    try:
        ...
        pass
    bot.send_message(message.chat.id, 'Список команд:\n/help - посмотреть хелп.\n/start - изменить почту и пароль.\n\Краткая инструкция:\nЕсли вы хотите изменить данные пользователя - введите команду \"/start\". После этого прекратится постановка текущей задачи, если она была и бот запустит регистрацию.\nВсе сообщения, пересланные сообщения и вложения, отправленные до нажатия кнопки \"Поставить задачу\" формируют описание.\nКнопка \"!Отменить постановку задачи\" - удаляет все введенные ранее данные и заново начинает процесс постановки задачи.\nПри выборе исполнителя можно ввести часть ФИО и бот при одном совпадении поставит задачу сразу, если совпадений больше - предложит список для выбора.')
